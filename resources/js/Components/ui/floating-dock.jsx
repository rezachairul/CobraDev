...
const FloatingDockDesktop = ({ items, className }) => {
  ...
  return (
    (<motion.div onMouseMove={(e) => mouseX.set(e.pageX)} onMouseLeave={() => mouseX.set(Infinity)} className={cn( "mx-auto hidden md:flex h-16 gap-4 items-end bg-dark px-4 pb-3", className )}>
      {items.map((item) => (
